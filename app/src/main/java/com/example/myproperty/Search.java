...
import com.example.myproperty.ResultDistanceMatrix.InfoDistanceMatrix;
        ...
        call.enqueue(new Callback<ResultDistanceMatrix>() {
            ...
            public void onResponse(Call<ResultDistanceMatrix> call, Response<ResultDistanceMatrix> response) {
                ...
                if ("OK".equalsIgnoreCase(resultDistance.status)) {
                    ...
                    InfoDistanceMatrix infoDistanceMatrix = resultDistance.rows.get(0);
                    InfoDistanceMatrix.DistanceElement distanceElement = (InfoDistanceMatrix.DistanceElement) infoDistanceMatrix.elements.get(0);
                    if ("OK".equalsIgnoreCase(distanceElement.status)) {
                        InfoDistanceMatrix.ValueItem itemDuration = distanceElement.duration;
                        InfoDistanceMatrix.ValueItem itemDistance = distanceElement.distance;
